...
<div class="flex flex-col gap-6 px-8 py-12">
    <div class="w-full flex flex-row gap-6 p-6 bg-white rounded-lg dark:bg-gray-800">
        ...
        <div class="flex flex-col gap-2">
            <p class="text-xl font-medium">Upload Lampiran Keperluan Audit Finance</p>
    ...
    <form class="p-8 py-12 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" method="GET" action="">
        <p class="text-xl">Lampiran Finance</p>
        ...
        <div class="flex flex-row w-full flex-wrap justify-between gap-8 pt-8">
            <div class="basis-[48%]">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Laporan transaksi harian</label>
            ...
            <div class="basis-[48%]">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Neraca keuangan</label>
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file">
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PDF, Word, XLSX (MAX. 2MB).</p>
            </div>
            <div class="basis-[48%]">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Laporan pajak</label>
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file">
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PDF, Word, XLSX (MAX. 2MB).</p>
            </div>
        </div>
