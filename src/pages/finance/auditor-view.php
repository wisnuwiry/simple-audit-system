...
$questions = [
    'Apakah sistem keuangan memiliki kontrol yang memadai untuk melacak dan mencatat transaksi harian dengan akurat?',
    'Apakah sistem menghasilkan laporan keuangan yang memadai (neraca, laporan laba/rugi) sesuai dengan standar akuntansi yang berlaku?',
    'Apakah sistem TI mendukung pembuatan dan pelaporan pajak yang akurat sesuai dengan regulasi yang berlaku di daerah setempat?',
];
