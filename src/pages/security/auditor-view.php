...
$questions = [
    'Apakah hak akses pengguna (misalnya, front office, housekeeping, keuangan) dikelola dengan baik untuk memastikan bahwa hanya pengguna yang berwenang yang dapat mengakses data sensitif?',
    'Apakah log aktivitas pengguna dipantau secara rutin untuk mendeteksi dan mencegah akses yang tidak sah atau aktivitas mencurigakan dalam sistem?',
    'Apakah laporan audit keamanan tersedia untuk semua aktivitas yang relevan, dan apakah dilakukan analisis terhadap potensi ancaman atau kerentanannya?',
];
