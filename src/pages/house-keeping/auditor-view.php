...
$files = [
    'Jadwal pembersihan kamar',
    'Laporan inspeksi kebersihan',
    'Inventaris kamar'
];

$questions = [
    'Apakah jadwal pembersihan dan inspeksi kebersihan dicatat dan dipantau secara teratur dalam sistem?',
    'Apakah ada sistem yang dapat melacak hasil inspeksi kebersihan dan memastikan bahwa semua kamar dipastikan dalam kondisi bersih dan siap digunakan?',
    'Apakah daftar inventaris kamar selalu diperbarui dengan akurat setelah setiap pembersihan atau inspeksi?',
];
