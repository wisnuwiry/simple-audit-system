...
$files = [
    ...
    'Data Integrasi Platform Internal'
];

$questions = [
    'Apakah tujuan sistem reservasi jelas terkait dengan kebutuhan operasional dan strategi bisnis hotel?',
    'Apakah sistem reservasi memiliki kontrol untuk mencatat dan mengelola log reservasi secara tepat dan lengkap?',
    'Apakah laporan reservasi harian secara otomatis disinkronkan dengan sistem lain yang digunakan oleh hotel, seperti sistem akuntansi atau CRM?',
    'Apakah ada pemantauan yang cukup terkait integrasi platform eksternal, untuk memastikan data dikirim dan diterima dengan benar?'
];
